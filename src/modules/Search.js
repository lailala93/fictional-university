...
class Search {
  ...
  constructor() {
    this.addSearchHTML(); // Has to be at the start, else the rest wont exist. 
      ...
      this.resultsDiv.html(`
        <div class="row">
          ...
          <div class="one-third">
              ...
              ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No campus matches that search. <a href="${universityData.root_url}/programs">View all campuses.</a></p>`}
  ...
  openOverlay() {
    ...
    return false; // This prevents default behavior of <a> or <link> elemenets 
  }
