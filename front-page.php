...
<div class="page-banner">
  ...
  <div class="page-banner__content container t-center c-white">
    <h1 class="headline headline--large">Welcome.This is another change. to test! AGAAAIN AGain</h1>
...
<div class="full-width-split group">
  ...
  <?php
      ...
      while ($homepageEvents->have_posts()) {
        ...
        get_template_part('/template-parts/content', 'event'); // get slug name
      }
      ?>
